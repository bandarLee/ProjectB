...
public enum CyberpunkMonster4State // 몬스터의 상태
{
    Idle,           // 대기
    Patrol,         // 순찰
    Trace,          // 추적
...
public class CyberpunkMonster4 : MonoBehaviour
{
    [Range(0, 10)]
    ...
    private CyberpunkMonster4State _cyberpunkMonster4State = CyberpunkMonster4State.Idle;  // 몬스터의 현재 상태
    ...
    private void Update()
    {
        ...
        switch (_cyberpunkMonster4State)
        {
            case CyberpunkMonster4State.Idle:
                Idle();
                break;

            case CyberpunkMonster4State.Patrol:
                Patrol();
                break;

            case CyberpunkMonster4State.Trace:
                Trace();
                break;

            case CyberpunkMonster4State.Comeback:
                Comeback();
                break;

            case CyberpunkMonster4State.Attack:
                Attack();
                break;

            case CyberpunkMonster4State.Damaged:
                Damaged();
                break;

            case CyberpunkMonster4State.Die:
                Die();
                break;
        }
    }
    ...
    private void Idle()
    {
        ...
        if (PatrolTarget != null && _idleTimer >= IDLE_DURATION)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Patrol;
        }
        ...
        if (Vector3.Distance(_target.position, transform.position) <= FindDistance)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Trace;
        }
    }
    ...
    private void Trace()
    {
        ...
        if (Vector3.Distance(transform.position, StartPosition) >= MoveDistance)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Comeback;
        }
        ...
        if (Vector3.Distance(_target.position, transform.position) <= AttackDistance)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Attack;
        }
    }
    ...
    private void Comeback()
    {
        ...
        if (!_navMeshAgent.pathPending && _navMeshAgent.remainingDistance <= TOLERANCE)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Idle;
        }
        ...
        //    _cyberpunkMonster4State = MonsterState.Trace;
    ...
    {
        if (_cyberpunkMonster4State == CyberpunkMonster4State.Die)
        {
            return;
        }
        ...
        if (Health <= 0)
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Die;
        }
        else
        {
            ...
            _cyberpunkMonster4State = CyberpunkMonster4State.Damaged;
        }
    }
