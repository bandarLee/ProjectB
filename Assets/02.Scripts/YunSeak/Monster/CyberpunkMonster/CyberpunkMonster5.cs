...
public enum CyberpunkMonster5State // 몬스터의 상태
{
    Idle,           // 대기
    Patrol,         // 순찰
    Attack,         // 근접공격
...
public class CyberpunkMonster5 : MonoBehaviour
{
    [Range(0, 10)]
    ...
    private CyberpunkMonster5State _cyberpunkMonster5 = CyberpunkMonster5State.Idle;  // 몬스터의 현재 상태
    ...
    private void Update()
    {
        ...
        switch (_cyberpunkMonster5)
        {
            case CyberpunkMonster5State.Idle:
                Idle();
                break;

            case CyberpunkMonster5State.Patrol:
                Patrol();
                break;
            ...
            case CyberpunkMonster5State.Attack:
                Attack();
                break;

            case CyberpunkMonster5State.Damaged:
                Damaged();
                break;

            case CyberpunkMonster5State.Die:
                Die();
                break;
        }
    }
    ...
    private void Idle()
    {
        ...
        if (PatrolTarget != null && _idleTimer >= IDLE_DURATION)
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Patrol;
        }
    ...
    private void Trace()
    {
        ...
        if (Vector3.Distance(transform.position, StartPosition) >= MoveDistance)
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Comeback;
        }
        ...
        if (Vector3.Distance(_target.position, transform.position) <= AttackDistance)
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Attack;
        }
    }
    ...
    private void Comeback()
    {
        ...
        if (!_navMeshAgent.pathPending && _navMeshAgent.remainingDistance <= TOLERANCE)
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Idle;
        }
    ...
    {
        if (_cyberpunkMonster5 == CyberpunkMonster5State.Die)
        {
            return;
        }
        ...
        if (Health <= 0)
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Die;
        }
        else
        {
            ...
            _cyberpunkMonster5 = CyberpunkMonster5State.Damaged;
        }
    }
